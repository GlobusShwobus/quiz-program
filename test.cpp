...
//CREATED A FILE AND DUMPED TEXT IN IT
//std::fstream Quiz_QnA;
//Quiz_QnA.open("Quiz_QnA.txt", std::ios::out);
//if (Quiz_QnA.is_open()) {
//    Quiz_QnA << "**Most popular programming language?**" << endl;
//    Quiz_QnA << "1.Java" << endl;
//    Quiz_QnA << "2.Python" << endl;
//    Quiz_QnA << "3.C++" << endl;
//    Quiz_QnA << "**Which of these does not belong?**" << endl;
//    Quiz_QnA << "1.World of Warcraft" << endl;
//    Quiz_QnA << "2.Elder scrolls online" << endl;
//    Quiz_QnA << "3.Call of duty" << endl;
//    Quiz_QnA << "**Most sold game ever?**" << endl;
//    Quiz_QnA << "1.Minecraft" << endl;
//    Quiz_QnA << "2.GTA5" << endl;
//    Quiz_QnA << "3.Tetris" << endl;
//    Quiz_QnA << "**Worlds biggest industry?**" << endl;
//    Quiz_QnA << "1.Automobil" << endl;
//    Quiz_QnA << "2.Fossil fuel" << endl;
//    Quiz_QnA << "3.Tech" << endl;
//    Quiz_QnA << "**Game of the decade contendor?**" << endl;
//    Quiz_QnA << "1.Genshin Impact" << endl;
//    Quiz_QnA << "2.Elden ring" << endl;
//    Quiz_QnA << "3.Starfield" << endl;
//    Quiz_QnA.close();
//}